...
//	Command::activate("guild", "$MODULE_NAME/reload_config.php", "reloadconfig", "admin");
	...
	Command::activate("msg", "$MODULE_NAME/system_cmd.php", "system", "admin");
	Command::activate("priv", "$MODULE_NAME/system_cmd.php", "system", "admin");
//	Command::activate("guild", "$MODULE_NAME/system_cmd.php", "system", "mod");

	Command::activate("msg", "$MODULE_NAME/cmdlist.php", "cmdlist", "admin");
	Command::activate("priv", "$MODULE_NAME/cmdlist.php", "cmdlist", "admin");
...
//	Command::activate("guild", "$MODULE_NAME/eventlist.php", "eventlist", "mod");
	...
	Command::activate("msg", "$MODULE_NAME/lookup.php", "lookup", "admin");
	Command::activate("priv", "$MODULE_NAME/lookup.php", "lookup", "admin");
