<?php
	...
	// Timer Module
	Command::register($MODULE_NAME, "", "timers.php", "timer", "all", "Set timers/Show running Timers");
	Subcommand::register($MODULE_NAME, "", "timers.php", "timer (.+)", "leader", "timer", "Sets a timer");
	CommandAlias::register($MODULE_NAME, "timer", "timers");
